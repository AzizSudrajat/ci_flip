...
class TextToImage {
     ...
     */
    public function createImage($text, $fontSize = 20, $imgWidth = 400, $imgHeight = 400){

        //text font path
        $font = 'fonts/GROVELANE.ttf';
        ...
        $angle= imagefilledrectangle($this->img, 0, 0, $imgWidth - 1, $imgHeight - 1, $white);
